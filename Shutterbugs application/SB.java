...
public class SB extends JFrame implements ActionListener{
	...
	SB(String title)
	{
		...
		inButton.setBounds(450 , 300 , 90 , 50);
		...
		outButton.setBounds(450 , 400 , 90 , 50);
		...
		searchButton.setBounds(450 , 500 , 90 , 50);
		...
		displayButton .setBounds(450 , 600 , 90 , 50);
		...
		img.setBounds(780 , 40, 200 , 200);
		Main.add(img);
		try
		{
			f=new File("C:\\Users\\HP\\Documents\\OOPM\\logo.png");
			image=ImageIO.read(f);
			Image i=image.getScaledInstance(200,200,BufferedImage.SCALE_FAST);
		...
		heading2.setFont(new Font("Courier New" , Font.BOLD , 70));
		heading2.setBounds(400 , 20, 400 , 40);
		Out.add(heading2);
		...
		File f3=null;
		img3=new JLabel();
		img3.setPreferredSize(new Dimension(200,200));
		img3.setBounds(780 , 40, 200 , 200);
		Out.add(img3);
		try
		{
			f3=new File("C:\\Users\\HP\\Documents\\OOPM\\logo.png");
		...
		heading3.setBounds(500 , 60, 400 , 40); ////////
		In.add(heading3);
		
		namel2 = new JLabel("Enter ID: ");
		namel2.setFont(new Font("SansSerif" , Font.PLAIN , 30));
		namel2.setBounds(150  , 220 ,  150 , 30);
		In.add(namel2);
		
		namet2=new JTextField(50);
		namet2.setBounds(300  , 220 ,  150 , 30);
		...
		try
		{
			f2=new File("C:\\Users\\HP\\Documents\\OOPM\\logo.png");
			image=ImageIO.read(f);
			Image i=image.getScaledInstance(180,180,BufferedImage.SCALE_FAST);
		...
		File f4=null;
		img4=new JLabel();
		img4.setPreferredSize(new Dimension(200,200));
	...
	public void actionPerformed(ActionEvent ae)		//HOW WILL NEXT AND PREVIOUS BE DECIDED
	{
		...
		else if(ae.getSource()==displayButton)
		{
			...
			for(int j=0; j<v2.size(); j++)
			{
				...
				System.out.println("Id:"+e.getId()+"  Name:"+ e.getName() + "  Camera:"+e.getCamera() + "  Lens:"+e.getLens() + "  Tripod:"+e.getTripod() + "  Card:"+e.getCard() +"  Event:"+ e.getEvent());
			}
		}
		...
		else if(ae.getSource()==search)
		{
			...
			for(int j=0;j<v.size();j++)
			{
				...
				{
					result.setText("Name: "+ f.getName() + "  Camera: "+f.getCamera() + "  Lens: "+f.getLens() + "  Tripod: "+f.getTripod() + "  Card: "+f.getCard() +"  Event:"+ f.getEvent()  );
				}
				else
				{
		...
		else if(ae.getSource()==returnedButton)
		{
			...
			Entry f=(Entry)v.get(k);
	        returned.setText("Name: "+ f.getName() + "  Camera: "+f.getCamera() + "  Camera: "+f.getLens() + "  Camera: "+f.getTripod() + "  Camera: "+f.getCard() +"  Event:"+ f.getEvent() );
			v.removeElementAt(k);
			namet2.setText("");
			commentt.setText("");
		}
